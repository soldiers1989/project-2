...
//		var file		= 'http://www.zi-han.net/theme/hplus/plugins/fullavatareditor/fullAvatarEditor.swf';		//flash文件的路径
//	var file			= 'plugins/fullavatareditor/fullAvatarEditor-000.swf';		//flash文件的路径
	var file			= 'plugins/fullavatareditor/fullAvatarEditor.swf';		//flash文件的路径
	var	version			= "10.1.0";						//播放该flash所需的最低版本
	var	expressInstall	= 'plugins/fullavatareditor/expressInstall.swf';			//expressInstall.swf的路径
	var	width			= 500;							//flash文件的宽度
