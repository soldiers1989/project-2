...
import com.ccclubs.quota.orm.model.CsStruct;
...
public interface CsStructMapper {
     ...
     * @mbg.generated
     */
    int updateByExampleSelective(@Param("record") CsStructWithBLOBs record,
        @Param("example") CsStructExample example);
     ...
     * @mbg.generated
     */
    int updateByExampleWithBLOBs(@Param("record") CsStructWithBLOBs record,
        @Param("example") CsStructExample example);
