...
//ORIGINAL LINE: public void setMultimediaDataId(uint value)
	...
	*/
	...
	public String toString()
	{
        ...
        .format("多媒体数据ID：%1$s,多媒体类型：%2$s,经度：%3$s，纬度：%4$s，数据包长度：%5$s", getMultimediaDataId(), getMultimediaType(), getPosition().getLatitude(), getPosition().getLongitude(), getMultimediaData().length));
