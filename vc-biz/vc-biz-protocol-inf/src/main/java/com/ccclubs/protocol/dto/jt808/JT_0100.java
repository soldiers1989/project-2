...
public class JT_0100 implements IMessageBody {
	...
	public String toString() {
        ...
        .format("省：%1$s,市：%2$s,制造商：%3$s，型号：%4$s，终端：%5$s，车牌颜色：%6$s，车牌号:%7$s", getProvinceId(), getCityId(), getManufactureId(),
				getTerminalModelNo(), getTerminalId(), getPlateColor(), getPlateNo()));
