...
public class JT808TransferService implements IJT808TransferService {
  ...
  private static Logger logger = LoggerFactory.getLogger(JT808TransferService.class);
   ...
   *
   * @see
   * com.ltmonitor.server.mina.IJT808TransferService#setJt808Server(com.ltmonitor
   * .jt808.service.IJT808Server)
   */
